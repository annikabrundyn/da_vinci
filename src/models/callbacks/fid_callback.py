    ...
    def on_train_epoch_end(self, trainer, pl_module):
        ...
        if trainer.current_epoch % self.epoch_logging_freq == 0:
            try:
                ...
                fid_val = -1
            pl_module.logger.experiment.add_scalar("train_fid", fid_val, self.trainer.global_step)
    ...
    def on_validation_epoch_end(self, trainer, pl_module):
        ...
        if trainer.current_epoch % self.epoch_logging_freq == 0:
            try:
                ...
                fid_val = -1
            pl_module.logger.experiment.add_scalar("valid_fid", fid_val, self.trainer.global_step)
