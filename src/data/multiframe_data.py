...
# class MFDaVinciDataSet(Dataset):
#     def __init__(self,
#                  data_dir: str,
#                  sample_list: list,
...
#
#
# class MFDaVinciDataModule(pl.LightningDataModule):
#     def __init__(
#             self,
#             data_dir: str,
#             frames_per_sample: int,
...
#
#         self.train_dataset = MFDaVinciDataSet(data_dir=self.data_dir,
...
#
#         self.val_dataset = MFDaVinciDataSet(data_dir=self.data_dir,
...
#                                         extra_info=self.extra_info)
#
#         self.test_dataset = MFDaVinciDataSet(data_dir=self.data_dir,
...
#                                          extra_info=self.extra_info)
#
#         self.vis_dataset = MFDaVinciDataSet(data_dir=self.data_dir,
