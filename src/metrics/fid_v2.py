...
class FIDCallback(pl.callbacks.base.Callback):
    ...
    def __init__(self, db_stats, z_sampler, fid_name, n_samples=5000, batch_size=32, eval_every=10000):
    ...
    def on_train_start(self, trainer, pl_module):
        ...
        '''
        self.z_samples = [self.z_sampler(self.batch_size, device=torch.device('cpu')) for i in
